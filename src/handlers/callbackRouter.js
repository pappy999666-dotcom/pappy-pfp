...
async function route(ctx, bot) {
  ...
  try {
    ...
    if (data === 'o_settings_wa_drop')            return ows.waDropPanel(ctx);
    if (data === 'o_wa_drop_toggle')              return ows.waDropToggle(ctx);
    if (data === 'o_wa_drop_times')               return ows.waDropTimesPrompt(ctx);
    if (data === 'o_wa_drop_images')              return ows.waDropImagesPrompt(ctx);
    if (data === 'o_wa_drop_cats')                return ows.waDropCatsPrompt(ctx);
    if (data === 'o_settings_wa_group')           return ows.waGroupPanel(ctx);
    if (data === 'o_wa_grp_toggle')               return ows.waGroupToggle(ctx);
    if (data === 'o_wa_grp_mention')              return ows.waGroupMentionToggle(ctx);
    if (data === 'o_wa_grp_times')                return ows.waGroupTimesPrompt(ctx);
    if (data === 'o_wa_grp_btn_text')             return ows.waGroupBtnTextPrompt(ctx);
    if (data === 'o_wa_grp_btn_url')              return ows.waGroupBtnUrlPrompt(ctx);
